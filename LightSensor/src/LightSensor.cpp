...
namespace
{
    constexpr const uint16_t BRIGHT_DAY_VALUE = 900;
    constexpr const uint16_t DARK_NIGHT_VALUE = 30;
} // anonymous
...
{
    const auto Difference = [](uint8_t valueOne, uint8_t valueTwo) -> uint8_t {
